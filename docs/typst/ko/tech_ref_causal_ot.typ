...
#table(
  ...
  [입력 차원], [161D (demographics, products, txn, derived\_temporal, product\_hierarchy, gmm)], [127D (demographics, products, txn, derived\_temporal, gmm)],
...
DeepFM, Causal, OT 세 Expert는 각각 서로 다른 피처 서브셋을 입력받지만(Causal: 161D, OT: 127D, FeatureRouter를 통한 슬라이싱), 추출하는 수학적 구조는 근본적으로 다르다:
