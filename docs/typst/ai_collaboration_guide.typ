...
#let pattern-block(title, principle, examples) = {
  ...
  block(width: 100%)[
    ...
    #block(
      ...
      #text(size: 10pt, fill: navy, weight: "bold", tracking: 0.1em)[실무 적용 예시]
      #v(4pt)
      #for ex in examples [
...
#align(center)[
  #text(size: 10pt, fill: muted, tracking: 0.15em)[금융 · 마케팅 · 사업 기획 실무자를 위한 실전 가이드]
  #v(0.3cm)
...
#align(center)[
  ...
  #v(0.2cm)
  #text(size: 16pt, fill: navy, weight: "bold")[목 차]
  #v(0.3cm)
