...
경제학은 수백 년의 과학적 방법론 --- 가설 수립, 이론적 프레임워크, 반증 가능성 --- 을 축적해왔다. 그러나 경제학 자체도 다른 학문에서 도구를 빌려온 역사가 있다: 일반균형이론은 물리학의 열역학 평형에서, 게임이론은 수학의 조합론에서, 계량경제학은 통계학에서 출발했다. 경제학이 과학인 것이 아니라, *학문 간 도구 전이가 과학 발전의 보편적 패턴*이다.
