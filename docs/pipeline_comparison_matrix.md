...
**남은 Should (1개, 후속 Phase)**:
- S6 ComplianceAuditStore SQL-queryable 통합 — AWS 측은 DynamoDB + S3 Parquet 이중구조로 이미 이식 완료. 남은 작업은 Athena view layer 로 regulator SQL 쿼리를 제공하는 인프라 단계.
