...
|---|-----------|--------|------|-----------|------|
| 1 | `mlp` | `MLPExpert` | `core/model/experts/mlp.py` | 전체 피처 (350D, 라우팅 없음) | 기본 MLP 베이스라인 (태스크 전용) |
...
| `pipeline.yaml` tasks | `configs/financial/pipeline.yaml` | Basket 역할 (14개 태스크 선택) |
