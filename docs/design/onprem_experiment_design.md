...
AWS 합성 데이터 ablation(Santander 941K x 350D, benchmark v4)에서 프레임워크 작동을 검증했다.
...
### Joint Ablation (FP32, 10ep, Santander 941K x 350D, benchmark v4)
