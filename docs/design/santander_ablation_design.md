...
Stage 5    레이블 파생        LabelDeriver: 14개 태스크 레이블 생성
...
```
engagement  "고객이 반응하는가"    [has_nba, next_mcc, top_mcc_shift]
            intra=0.8, inter=0.3
...
| `tasks_8` | 8 | + Tier 2 Derived + Tier 5 Txn NBA |
| `tasks_12` | 12 | + Tier 3 Product Group + Segmentation (일부) |
| `tasks_14` | 14 | 전체 (Tier 3 완전 포함) |
