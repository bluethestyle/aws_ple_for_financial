...
Usage::
    ...
    loss_fn = DistillationLoss(temperature=1.0, alpha=0.3)
...
from core.training.feature_group_distillation import FeatureGroupDistillation  # re-exported for backwards compatibility
...
class DistillationLoss(nn.Module):
    ...
    * Regression: MSE between teacher and student outputs.
    ...
    def __init__(self, temperature: float = 1.0, alpha: float = 0.3) -> None:
        super().__init__()
