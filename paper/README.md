...
| # | 문서 | 내용 |
|---|------|------|
| 00 | [project_background.md](00_project_background.md) | ALS→BL→PLE 선택 과정, 4축 설계 원칙, 기술 전환점 |
| 01 | [architecture_positioning.md](01_architecture_positioning.md) | 핵심 주장, 데이터 5축→expert 매핑, 출력 설명 아키텍처 |
